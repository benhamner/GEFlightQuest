...
if __name__=="__main__":
    training_days_path = os.path.join(os.environ["DataPath"], "GEFlight", "Release 6", "FinalEvaluationTrainDays")
    test_days_path = os.path.join(os.environ["DataPath"], "GEFlight", "Release 6", "FinalEvaluationSet")
    solution_path = os.path.join(os.environ["DataPath"], "GEFlight", "Release 6", "FinalEvaluationSolution")
